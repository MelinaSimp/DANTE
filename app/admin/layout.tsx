...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-black flex">
      {/* Sidebar */}
      <div className="hidden md:flex flex-col w-56 border-r border-orange-500/20 bg-black shrink-0">
        <div className="p-5 border-b border-orange-500/20">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-orange-500 ml-1.5 font-semibold uppercase tracking-wider">Admin</span>
            </div>
          </div>
        </div>
