...
export default function DataSourcesPage({ agentId }: DataSourcesPageProps) {
  ...
  return (
    <div className={`h-full flex flex-col overflow-y-auto ${colors.text}`} style={{ backgroundImage: 'url(/backgrounds/forest.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
