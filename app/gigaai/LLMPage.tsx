                      ...
                      <div className="mt-3 space-y-2 pt-3 border-t border-white/20">
                        {message.files.map((file) => {
                          ...
                          return (
                            <div
                              key={file.id}
                              className={`${isImage ? 'p-2' : ''} bg-white/10 rounded-lg ${isImage ? '' : 'px-3 py-2 flex items-center gap-2'}`}
                            >
                              {isImage ? (
                ...
                <div className="mb-3 flex flex-wrap gap-2">
                  {uploadedFiles.map((file) => {
                    ...
                    return (
                      <div
                        key={file.id}
                        className={`${isImage ? 'p-2' : ''} bg-white/10 rounded-lg border border-white/20 ${isImage ? '' : 'flex items-center gap-2 px-3 py-2'}`}
                      >
                        {isImage ? (
