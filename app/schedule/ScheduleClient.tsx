              ...
              <div className="border-t border-[var(--rule)] pt-4">
                ...
                <label className="flex items-center gap-2 cursor-pointer mb-1">
                  ...
                  <span className="text-xs text-[var(--ink-muted)]">
                    Email{selectedAppointment.contacts?.email ? ` (${selectedAppointment.contacts.email})` : ""}
                  </span>
                </label>
                {!selectedAppointment.contacts?.email && (
                  <p className="text-[11px] text-[var(--ink-subtle)] mb-2 ml-6">
                    Sends to your account email. Set it in Settings &gt; Account.
                  </p>
                )}
