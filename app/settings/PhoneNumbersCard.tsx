        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              placeholder="AC••••••••••••••••••••••••••••••••"
              className="mt-1 w-full px-3 py-2 text-sm bg-[var(--canvas)] border border-[var(--rule)] rounded-[4px] text-[var(--ink)] outline-none focus:border-[var(--accent)] font-mono"
              autoComplete="off"
              spellCheck={false}
            />
          </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="shrink-0">
          <select
            ...
            className="px-3 py-1.5 text-sm bg-[var(--canvas)] border border-[var(--rule)] rounded-[4px] text-[var(--ink)] outline-none focus:border-[var(--accent)] disabled:opacity-50 min-w-[180px]"
          >
        ...
        <div className="mt-2 space-y-2">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 px-3 py-1.5 text-sm bg-[var(--canvas)] border border-[var(--rule)] rounded-[4px] text-[var(--ink)] outline-none focus:border-[var(--accent)] font-mono"
            />
            <button
