...
export default function LeaseAbstractorClient() {
  ...
  const exportCSV = () => {
    ...
    rows.push([]);
    rows.push(["DISCLAIMER: AI-generated abstract. Review by qualified professional recommended. Extracted values should be verified against the source document before use in any transaction, negotiation, or legal proceeding."]);
  ...
  const exportXLSX = () => {
    ...
    // Disclaimer sheet
    const disclaimerWs = XLSX.utils.aoa_to_sheet([
      ["DISCLAIMER"],
      ...
      [],
      ["Generated by Drift AI -- driftai.studio"],
    ]);
    disclaimerWs["!cols"] = [{ wch: 80 }];
