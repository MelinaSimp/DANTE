...
export const metadata: Metadata = {
  ...
  description:
    "Build agents, sites, and workflows on an almost hallucination-free LLM. Citation-grounded answers for anyone — deployed in minutes, no code required.",
  manifest: "/manifest.json",
  icons: {
    icon: "/brand/logo-new.png",
