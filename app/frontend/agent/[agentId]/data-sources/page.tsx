// app/frontend/agent/[agentId]/data-sources/page.tsx - Data Sources Page with Apple-style Light Theme
"use client";
  ...
  const handleDrop = async (e: React.DragEvent) => {
    ...
    for (const file of files) {
      try {
        ...
        if (!response.ok) {
          throw new Error("Failed to create data source record");
        }
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-4 flex gap-2 flex-wrap">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl border border-gray-300 bg-white text-gray-900 text-sm font-medium transition hover:bg-gray-50"
              >
                + Add API Key
              </button>
              <button
                ...
                className="px-4 py-2 rounded-xl border border-gray-300 bg-white text-gray-900 text-sm font-medium transition hover:bg-gray-50 flex items-center gap-2"
              >
            ...
            {showApiKeyInput && (
              <div className="mb-4 p-4 rounded-2xl border border-gray-200 bg-white">
                <div className="space-y-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">API Key Type</label>
                    <select
                      value={apiKeyType}
                      onChange={(e) => setApiKeyType(e.target.value as "google_calendar" | "custom")}
                      className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-blue-500 focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none"
                    />
                  </div>
                  <div>
              ...
              {loading ? (
                ...
                <label htmlFor="file-upload" className="cursor-pointer block">
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-700 mb-2">Drag and drop knowledge base files here</p>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {dataSource.type === "file" && 
                             ...
                             dataSource.content.trim().length > 0 && (
                              <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" title="Text extracted successfully" />
                            )}
                          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="relative w-full max-w-4xl max-h-[90vh] rounded-2xl border border-gray-200 bg-white flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">{previewModal.dataSource.name}</h3>
