-- ============================================
-- DRIFT AGENT BUILDER - COMPLETE DATABASE SETUP
-- ============================================
...
CREATE TABLE IF NOT EXISTS steps (
  ...
  name TEXT NOT NULL,
  type TEXT NOT NULL CHECK (type IN ('say', 'gather', 'code', 'api_call', 'if', 'schedule')),
  code TEXT,
  ai_message TEXT,
...
-- ============================================
-- 7. STORAGE BUCKET SETUP (for file uploads)
-- ============================================
-- Note: Run this in Supabase Dashboard > Storage > Create Bucket
-- Bucket name: "agent-files"
-- Public: false (private bucket)
-- File size limit: 50MB
-- Allowed MIME types: */* (or specify: application/pdf,text/plain,application/json,image/*,etc.)
