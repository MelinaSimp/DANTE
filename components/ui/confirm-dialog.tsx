      ...
      {state && (
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-white/10 bg-[var(--canvas)]/5 flex items-center justify-end gap-3">
              <button
                onClick={() => handleClose(false)}
                className="px-4 py-2 rounded-xl border border-white/20 bg-transparent text-white text-sm font-medium hover:bg-[var(--canvas)]/10 transition"
              >
