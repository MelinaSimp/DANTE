    ...
    <div className="space-y-8 text-[#151515]">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/call"
            className="inline-flex items-center gap-2 rounded-full border border-[var(--glass-border)] bg-[var(--canvas)] px-4 py-2 text-sm font-medium text-[#151515] shadow-sm transition hover:border-red-500 hover:text-red-600"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[var(--glass-border)] bg-[var(--canvas)] px-4 py-2 text-sm font-medium text-[#151515] shadow-sm transition hover:border-[#3166bf] hover:text-[#3166bf]"
          >
      ...
      {showAddForm && (
        <div className="rounded-2xl border border-[var(--glass-border)] bg-[#ffffff] p-6 shadow-lg">
      ...
      {contacts.length === 0 ? (
        <div className="rounded-2xl border border-[var(--glass-border)] bg-[#ffffff] p-12 text-center shadow-lg">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 xl:grid-cols-3">
          {contacts.map((contact) => (
            <div
              key={contact.id}
              className="group rounded-3xl border border-[var(--glass-border)] bg-[#ffffff] p-8 shadow-sm transition-all duration-200 hover:-translate-y-2 hover:border-[#3166bf]/50 hover:shadow-md"
            >
              <div className="mb-5 flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-1.5">
                  <Link
                    ...
                    className="inline-flex items-center gap-1 rounded-full border border-[var(--glass-border)] bg-[var(--glass-hover)] px-3 py-1 text-xs font-medium text-[#151515] transition hover:border-[#3166bf] hover:bg-[#3166bf]/10 hover:text-[#3166bf]"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1 rounded-full border border-[var(--glass-border)] bg-[var(--glass-hover)] px-3 py-1 text-xs font-medium text-[#151515] transition hover:border-red-500 hover:bg-red-50 hover:text-red-600"
                  ...
                  <Button
                    ...
                    className="rounded-full border border-[var(--glass-border)] bg-[var(--glass-hover)] px-3 py-1 text-xs font-medium text-[#151515] transition hover:border-[#3166bf] hover:bg-[#3166bf]/10 hover:text-[#3166bf]"
                  >
                    Details
                  </Button>
                  <Button
                  ...
                  <Button
                    ...
                    className="rounded-full border border-[var(--glass-border)] bg-[var(--glass-hover)] px-3 py-1 text-xs font-medium text-[#f0494a] transition hover:border-[#f0494a] hover:bg-[#fef2f2] hover:text-[#f0494a] disabled:opacity-50"
                  >
                ...
                {contact.notes && (
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-2 rounded-lg border border-[var(--glass-border)] bg-[var(--glass-hover)] p-3 text-sm text-[#151515]/70">{contact.notes}</p>
                    </div>
                  </div>
                )}
                
                <div className="rounded-lg border border-[var(--glass-border)] bg-[var(--glass-hover)] p-3 text-xs text-[#151515]/60">
      ...
      {selectedContact && (
        <div className="mt-12 space-y-8 rounded-3xl border border-[var(--glass-border)] bg-[#ffffff] p-8 shadow-lg">
          <div className="flex flex-col gap-4 border-b border-[var(--glass-border)] pb-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
            ...
            <Button
              ...
              className="rounded-full border border-[var(--glass-border)] bg-[var(--glass-hover)] px-4 py-2 text-sm font-medium text-[#151515] transition hover:border-[#151515] hover:bg-[#e5e7eb]"
            >
              ✕ Close
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            {/* Contact Info */}
            <div className="rounded-2xl border border-[var(--glass-border)] bg-[#ffffff] p-6 shadow-sm">
              ...
              <div className="space-y-5 text-sm">
                ...
                {selectedContact.notes && (
                  <div>
                    <span className="text-xs uppercase tracking-wide text-[#151515]/60">Notes</span>
                    <div className="mt-2 rounded-xl border border-[var(--glass-border)] bg-[var(--glass-hover)] p-3 text-[#151515]/70">
                      {selectedContact.notes}
                    </div>
                  </div>
                )}
          ...
          <div className="rounded-2xl border border-[var(--glass-border)] bg-[#ffffff] p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              {notes.map((note) => (
                <div key={note.id} className="rounded-xl border border-[var(--glass-border)] bg-[var(--glass-hover)] p-4 shadow-sm transition hover:border-[#3166bf] hover:shadow-md">
          ...
          <div className="rounded-2xl border border-[var(--glass-border)] bg-[#ffffff] p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              {tasks.map((task) => (
                <div key={task.id} className="rounded-xl border border-[var(--glass-border)] bg-[var(--glass-hover)] p-4 shadow-sm transition hover:border-[#3166bf] hover:shadow-md">
                  <TaskItem task={task} />
                </div>
              ))}
              {tasks.length === 0 && (
