...
const ADAPTERS: Record<string, () => Promise<IntegrationAdapter>> = {
  ...
  salesforce: async () => (await import("./adapters/salesforce")).makeSalesforceAdapter(),
  ...
  costar: async () => (await import("./adapters/costar")).makeCoStarAdapter(),
  ...
  placer_ai: async () => (await import("./adapters/placer-ai")).makePlacerAiAdapter(),
