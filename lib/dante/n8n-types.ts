...
export const DRIFT_TO_N8N_NODE_TYPE: Record<string, string> = {
  ...
  market_comps:      "n8n-nodes-drift-cre.driftMarketComps",
  underwrite:        "n8n-nodes-drift-cre.driftUnderwriter",
  lease_abstract:    "n8n-nodes-drift-cre.driftLeaseAbstractor",
