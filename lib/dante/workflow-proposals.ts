...
6. "node_sketch" is an ordered list of the Drift node types this workflow would use. Valid types: "trigger_manual", "trigger_cron", "trigger_webhook", "trigger_at", "trigger_lease_expiry", "trigger_deal_stage", "http", "openai", "query_clients", "query_properties", "lease_lookup", "update_contact", "send_email", "send_sms", "condition", "delay", "archive_lookup", "agent", "web_search", "integration_query", "generate_document", "for_each", "transform", "switch", "sub_workflow", "approval". First element must be a trigger.
