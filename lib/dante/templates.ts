  ...
  nodes: [
    ...
    },
    {
      ...
      data: { step: {
        ...
        config: {
          model: "claude-sonnet-4-6",
          system: "You are a CRE void analyst. Your job is to identify what is MISSING from a trade area -- which business categories have no presence, which corridor segments are underserved, and where vacant or underutilized parcels exist. Always cite every data point with [ss:N] markers. Be specific about acreage, zoning, assessed values, and land use. Do NOT recommend specific tenants or write tenant repositioning plans. Report the voids and let the broker decide what to do with them.",
