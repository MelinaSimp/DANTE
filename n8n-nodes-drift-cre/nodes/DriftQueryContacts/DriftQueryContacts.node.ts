    ...
    properties: [
      {
        ...
        type: "string",
        default: "",
        placeholder: "e.g. stage, review_stage, company_id",
        description: "Column name to filter contacts by (leave empty for all contacts). Common: stage, review_stage, company_id.",
      },
      {
      ...
      },
      {
        ...
        name: "selectFields",
        type: "string",
        default: "id, name, full_name, email, phone, stage, company_id, created_at",
